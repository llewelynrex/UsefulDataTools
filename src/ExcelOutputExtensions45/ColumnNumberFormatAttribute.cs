...
namespace UsefulDataTools
{
   ...
   public class ColumnNumberFormatAttribute : Attribute
   {
      ...
      {
         var currentCultureNumberFormat = CultureInfo.CurrentCulture.NumberFormat;

         var datePattern = ExcelOutputConfiguration.DefaultDateFormat;
         var timePattern = ExcelOutputConfiguration.DefaultTimeFormat;
         var currencySymbol = currentCultureNumberFormat.CurrencySymbol;
         var currencyDecimalSeparator = currentCultureNumberFormat.CurrencyDecimalSeparator;
         var currencyGroupSeparator = currentCultureNumberFormat.CurrencyGroupSeparator;
